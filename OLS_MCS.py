...
if all_fold_losses:
    ...
    fold_losses_df.to_csv("ols_fold_losses_mcs.csv", index=False)
    print(f"\nFold losses for MCS testing saved to ols_fold_losses_mcs.csv")
...
print("\nResults saved to:")
print("- best_models_ols.csv (best models summary)")
print("- var_imp_ols.csv (variable importance)")
print("- mcs_results_ols.csv (Model Confidence Set results)")
print("- ols_fold_losses_mcs.csv (fold-level losses for MCS testing)")
